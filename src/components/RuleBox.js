  ...
  return (
    ...
    <div className={styles.rule_box}>
      ...
      <div className={styles.rule_list}>
        <ol>
        <li>You will have only <span style={{fontWeight:"bold"}}>15 seconds</span> per each question.</li>
      ...
      <div className={styles.rule_footer}>
        <div className={styles.exit}><button onClick={props.prev} type='button' className='quiz-button' id = 'replay'>Exit Quiz</button></div>
        <div className={styles.continue}><button onClick={props.next} type='button' className='quiz-button' id='quit'>Continue</button></div>
      </div>
    </div>
    </>
  )
